...
def listar_proprietarios():
    janela = tk.Toplevel()
    janela.title("Lista de Proprietários")
...
root = tk.Tk()
root.title("Sistema de Veículos")

tk.Button(root, text="Cadastrar Proprietário", command=cadastrar_proprietario).pack(pady=10)
tk.Button(root, text="Listar Proprietários", command=listar_proprietarios).pack(pady=10)
